module.exports = class pouleGames {
    ...
    makeGames() {
        ...
        if (numPlayers == 1) {
            let singlePlayerDiv = $(`<div id="singlePlayerDiv" class="singlePlayerDiv"><h3>Winnaar:</h3><h4>${this.players[0].name}!</h4></div>`);
    ...
    sort() {
        this.rankings = this.players.slice();
        ...
        if (this.lastRankings.length > 0) {
            ...
            */
            newRankings = this.rankingsEqual(this.lastRankings, this.rankings);
        } else {
            newRankings = true;
        }
        ...
        if (newRankings) {
            ...
            this.lastRankings = this.rankings.slice();
        }
    }
    ...
    rankingsEqual(oldRankings, newRankings) {
        return Object.keys(oldRankings).length === Object.keys(newRankings).length && Object.keys(oldRankings).every(p => oldRankings[p] === newRankings[p]);
    }
}